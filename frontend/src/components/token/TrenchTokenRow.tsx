...
export function TrenchTokenRow({ token }: TrenchTokenRowProps) {
  ...
  return (
    <div
      ...
      className="revolving-border cursor-pointer"
    >
      <div className="relative z-[1] bg-card rounded-[7px] flex items-start gap-3 p-3 hover:bg-elevated transition-colors">
        {/* Token image */}
